...
class Regions{
    ...
    private static let regions : [Region] =
        [Region(searchStrings: ["luzern", "sursee"], queryKey: "luzern", centerCoordinate: CLLocationCoordinate2DMake(47.050167, 8.309307), areaSize: 6000),
         ...
         Region(searchStrings: ["baden"], queryKey: "baden", centerCoordinate: CLLocationCoordinate2DMake(47.473511,8.306314), areaSize: 6000),
         Region(searchStrings: ["basel"], queryKey: "baselstadt", centerCoordinate: CLLocationCoordinate2DMake(47.473511,8.306314), areaSize: 6000),
         Region(searchStrings: ["bern", "bärn"], queryKey: "bern", centerCoordinate: CLLocationCoordinate2DMake(47.473511,47.473511), areaSize: 6000),
         Region(searchStrings: ["biel"], queryKey: "biel", centerCoordinate: CLLocationCoordinate2DMake(47.473511,8.306314), areaSize: 6000),
         Region(searchStrings: ["chur"], queryKey: "chur", centerCoordinate: CLLocationCoordinate2DMake(47.473511,8.306314), areaSize: 6000),
